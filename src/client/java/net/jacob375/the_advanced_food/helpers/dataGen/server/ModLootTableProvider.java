...
public class ModLootTableProvider extends FabricBlockLootSubProvider {
        ...
        public ModLootTableProvider(FabricPackOutput packOutput, CompletableFuture<Provider> registriesFuture) {
                super(packOutput, registriesFuture);
                fortune = registriesFuture.join().lookupOrThrow(Registries.ENCHANTMENT)
        ...
        private LootTable.Builder orangeLeavesDrops() {
                return LootTable.lootTable()
                                ...
                                .withPool(LootPool.lootPool()
                                                ...
                                                .add(applyExplosionDecay(ModBlocks.ORANGE_LEAVES, LootItem
                                                                .lootTableItem(Items.STICK)
                                                                .apply(SetItemCountFunction.setCount(
                                                                                ContextIntProviders.between(1, 2))))
                                                                .when(BonusLevelTableCondition.bonusLevelFlatChance(
                                                                                fortune,
                                                                                0.02F, 0.022222223F, 0.025F,
                                                                                0.033333335F, 0.1F))))

                                .withPool(LootPool.lootPool()
                                                .setRolls(ContextIntProviders.exactly(1))
                                                .when(doesNotHaveShearsOrSilkTouch())
                                                .add(applyExplosionCondition(ModBlocks.ORANGE_LEAVES,
